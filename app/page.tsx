...
const features = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet quia hic voluptatibus sunt minima dolorem mollitia odio dolore, amet cumque.",
    icon: GlobeIcon,
  },
  {
        ...
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              summarize content and will answer all your Qs. Ideal for everyone,{" "}
